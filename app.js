...
import { getFirestore, collection, addDoc, onSnapshot, query, orderBy, limit, serverTimestamp, doc, deleteDoc } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
            ...
            <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 flex gap-3" data-category="${c.category}" data-id="${c.id}">
                ...
                <div class="flex-grow min-w-0">
                    ...
                    <div class="flex items-center justify-between mt-2">
                        <a href="https://wa.me/${c.whatsapp}?text=${encodeURIComponent('Hola! Vi tu anuncio de "' + c.title + '" en La Bajada App')}" target="_blank" class="bg-green-500 text-white px-3 py-1 rounded-full text-xs font-bold hover:bg-green-600 transition-colors flex items-center gap-1">
                        ...
                        ${isOwner ? `<button onclick="deleteClassified('${c.id}')" class="text-red-500 hover:text-red-700 text-xs font-medium flex items-center gap-1">
