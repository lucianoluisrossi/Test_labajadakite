...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function compressImage(file) {
        return new Promise((resolve, reject) => {
            ...
            const QUALITY = 0.7;    // Calidad JPEG (70%)
    ...
    // CORRECCIÓN: Función nombrada para poder reutilizarla en el event listener
    const handleGalleryUpload = async (e) => {
        ...
        // Guardamos el contenido original del botón para restaurarlo luego
        ...
        try {
            ...
            // alert("¡Foto subida con éxito!"); // Opcional: quitar para que sea más fluido
            ...
            // Restaurar botón
            const label = document.querySelector('label[for="gallery-upload-input"]') || parent;
            label.innerHTML = originalContent;
            
            // Reasignar el listener al NUEVO input creado
        ...
        try {
            ...
            if (json.code === 0 && json.data) {
                ...
                if (gustInfoContainer) {
                    updateCardColors(gustInfoContainer, getWindyColorClasses(windGustValue));
                }
